    	...
    	<div id="box" style="padding-top:20px;">
     	...
     	<div id="box" style="width:100%;">
       	...
       	<div id="box" style="width:100%;"> 
			...
			<?php $query_additional=mysqli_query($db->conn, "select brand.id as id ,band.brand_name as name  from brand join map_type_to_brand on brand.id=map_type_to_brand.brand_id where type_id='" . mysqli_real_escape_string($db->conn, $_REQUEST['id'] ?? '') . "' order by band.brand_name");
			...
			<?php $query_additional=mysqli_query($db->conn, "select brand.id as id ,band.brand_name as name from brand where id not in (select brand_id from map_type_to_brand where type_id='" . mysqli_real_escape_string($db->conn, $_REQUEST['id'] ?? '') . "') order by band.brand_name");
