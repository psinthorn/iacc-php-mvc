 ...
 * Standalone mPDF view — same data conditions as checkin-print
 */
...
<style>
    ...
    .section-header { background: #1d4ed8; color: white; padding: 6px 10px; font-size: 12px; font-weight: bold; margin: 12px 0 4px; border-radius: 3px; }
    .agent-sub { background: #eff6ff; padding: 4px 10px; font-size: 10px; font-weight: bold; color: #1e40af; margin: 6px 0 3px; border-left: 3px solid #1d4ed8; }
    ...
    table.insurance td { padding: 4px 5px; font-size: 9px; border: 1px solid #e2e8f0; vertical-align: top; }
    table.insurance tr.blank td { height: 30px; }
...
// Table header row template — same columns as checkin (to be adjusted later)
$thRow = '<tr>
    ...
    <th style="width:130px;">' . ($isThai ? 'ตัวแทน' : 'Agent') . '</th>
