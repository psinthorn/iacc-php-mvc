...
<div class="qa-card">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if(!$isCancelled): ?><a class="action-btn danger" onClick="return Conf(this)" href="index.php?page=po_store&method=D&id=<?=$d['id']?>&csrf_token=<?=csrf_token()?>"><i class="fa fa-trash"></i></a><?php endif; ?>
        </td>
    </tr>
