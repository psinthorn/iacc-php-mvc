...
<style>
    ...
    .filter-card .btn-primary { background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); border: none; border-radius: 10px; padding: 10px 20px; font-weight: 600; }
    .filter-card .btn-primary:hover { box-shadow: 0 4px 12px rgba(231,76,60,0.35); }
    ...
    .date-presets .btn.active { background: linear-gradient(135deg, #e74c3c, #c0392b); color: white; border-color: #c0392b; }
    ...
    .pagination-footer .per-page-inline select:focus { border-color: #e74c3c; outline: none; box-shadow: 0 0 0 2px rgba(231,76,60,0.15); }
...
<div class="voucher-wrapper">
    ...
    <div class="filter-card">
        ...
        <div class="filter-body">
            <form method="get" action="">
                ...
                <div class="date-presets"><?= render_date_presets($date_preset, 'voucher_list') ?></div>
                <?php endif; ?>
                <div class="row">
                    <div class="col-xs-12 col-sm-4" style="margin-bottom:12px;">
                        <input type="text" class="form-control" name="search" placeholder="<?=$xml->search ?? 'Search'?> Voucher#, Vendor..." value="<?=e($search)?>">
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-2" style="margin-bottom:12px;">
                        ...
                        <a href="?page=voucher_list" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="pagination-footer">
        ...
        <?= render_pagination($pagination, '?page=voucher_list', $query_params) ?>
        <?php endif; ?>
