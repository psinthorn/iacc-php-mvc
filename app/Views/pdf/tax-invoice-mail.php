<?php
/**
 * Tax Invoice Email PDF Generator
...
$que_pro=mysqli_query($db->conn, "select type.name as name,product.price as price,discount,model.model_name as model,quantity,pack_quantity,product.des as des,activelabour,valuelabour from product left join type on product.type=type.id left join model on product.model=model.id where po_id='".$id."'");$summary=0;
$cot=1;
