<?php
/**
 * Invoice Payment Cancel View (standalone HTML)
 * Variables: $invoiceId, $invoiceData, $title, $message, $icon
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
        ...
        .result-icon i { font-size: 80px; color: #f39c12; }
        .icon-wrapper { width: 100px; height: 100px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; background: rgba(243, 156, 18, 0.1); }
        ...
        .invoice-info { background: #f8f9fa; border-radius: 12px; padding: 20px; margin: 20px 0; text-align: left; }
        ...
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(52, 152, 219, 0.3); }
        .btn-secondary { background: #f0f0f0; color: #333; }
        .btn-secondary:hover { background: #e0e0e0; }
        .help-text { background: #fff3cd; border: 1px solid #ffc107; border-radius: 10px; padding: 15px; margin-top: 20px; font-size: 0.9rem; color: #856404; }
        .help-text i { margin-right: 8px; }
    </style>
</head>
<body>
    <div class="result-container">
        <div class="result-icon"><div class="icon-wrapper"><i class="fa <?= $icon ?>"></i></div></div>
        <div class="result-content">
            ...
            <div class="invoice-info">
                ...
                <div class="detail-row"><span class="detail-label">Status</span><span class="detail-value" style="color:#f39c12;">Unpaid</span></div>
            </div>
            <?php endif; ?>
            ...
            <div class="help-text"><i class="fa fa-question-circle"></i> Need help? Contact us if you continue experiencing issues with your payment.</div>
        </div>
    </div>
</body>
</html>
