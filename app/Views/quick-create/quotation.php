...
.quick-create-page .section-title i { color: #667eea; }
...
.quick-create-page .form-group .form-control:focus { border-color: #667eea; box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1); outline: none; }
...
.quick-create-page .labour-field input[type="checkbox"] { width: 20px; height: 20px; cursor: pointer; accent-color: #667eea; flex-shrink: 0; }
...
.quick-create-page .btn-submit:hover {
    transform: translateY(-2px); box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3);
}
...
<div class="page-header-qc">
    <div>
        <h2><i class="fa fa-file-text-o"></i> <?= $isThaiLang ? 'สร้างใบเสนอราคาด่วน' : 'Quick Create — Quotation' ?></h2>
        <div class="subtitle"><?= $isThaiLang ? 'ระบบจะสร้างใบขอซื้อ (PR) ให้อัตโนมัติ' : 'System will auto-create a Purchase Request (PR)' ?></div>
    </div>
...
<div class="auto-info-banner">
    ...
    <div class="info-text">
        ...
        <?= $isThaiLang ? 'ใบขอซื้อ (PR) จะถูกสร้างให้อัตโนมัติเมื่อบันทึก' : 'A Purchase Request (PR) will be auto-generated when you save.' ?>
    </div>
</div>

<form method="POST" action="index.php?page=qc_store" id="qcForm">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="entry_type" value="quotation">
    ...
    <div class="form-card">
        <div class="form-actions" style="border-top:none; margin-top:0; padding-top:0;">
            ...
            <a href="index.php?page=qa_list" class="btn btn-default" style="padding:14px 24px; border-radius:10px; border-color:#667eea; color:#667eea;">
                <i class="fa fa-list"></i> <?= $isThaiLang ? 'รายการใบเสนอราคา' : 'Quotation List' ?>
            </a>
            <button type="submit" class="btn-submit">
                <i class="fa fa-bolt"></i> <?= $isThaiLang ? 'สร้างใบเสนอราคา' : 'Create Quotation' ?>
            </button>
        </div>
    </div>
</form>
