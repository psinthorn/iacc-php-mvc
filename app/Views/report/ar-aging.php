...
<style>
    .aging-wrapper { padding: 20px; max-width: 1400px; margin: 0 auto; font-family: 'Inter', sans-serif; }
    .aging-header { padding: 24px; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); border-radius: 16px; box-shadow: 0 10px 40px rgba(239, 68, 68, 0.25); color: white; margin-bottom: 30px; display: flex; justify-content: space-between; align-items: center; }
    .aging-header h2 { font-size: 28px; font-weight: 700; margin: 0; }
